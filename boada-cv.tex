...
\textit{Fellow} \hfill \textbf{January, 2020 - Present}\newline
    \begin{list2}
    	...
    	\item Trained a random forest in Python to prioritize NYC restaurant inspections based on environmental variables and their past inspection histories and provided the results to NYC through an easy to use API.
    	\item Resulted in a $\sim$2.5\% improved performance of NYC inspectors, leading to critical violations being discovered up to 7 days earlier than by the current approach implemented by NYC.
    \end{list2}
\vspace*{-2mm}
...
\textit{Postdoctoral Research Associate} \hfill \textbf{September, 2016 - 2020}\newline
    \begin{list2}
      ...
      to perform quality control tasks; deliver science products; and produce peer-reviewed publications.
    	\item Contributed to open source, astronomy-focused, Python projects through bug fixes and feature additions: see \href{https://github.com/boada/photometrypipeline}{\sc{photometrypipeline}}, \href{http://astlib.sourceforge.net/}{\sc{astLib}}, and \href{https://github.com/boada/easyGalaxy}{\sc{easyGalaxy}} on Github as examples.
    \end{list2}
\vspace*{-2mm}
...
\textit{Ph.D Candidate} \hfill \textbf{August, 2010 - 2016}\newline
    \begin{list2}
    	\vspace*{-5mm}
      \item Demonstrated that traditional statistical methods could be improved by up to a factor of 3, when combined with machine learning, specifically for a planned large observation campaign.
