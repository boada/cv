...
\textit{Senior Data Scientist, Gameplay} \hfill \textbf{January, 2024 - 2026}\newline
    \begin{list2}
        \vspace*{-5mm}
        \item Restarted advanced, gameplay analytics support for partner studios and on-going Call of Duty titles.
        \item Highlighted Project: Led the study design and analysis of input advantage which resulted in a rework of the controller aim assist system in Black Ops 7 (2025). 
    \end{list2}
    \vspace*{-2mm}
