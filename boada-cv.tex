...
\textit{Senior Machine Learning Engineer} \hfill \textbf{January, 2021 - Present}\newline
    \begin{list2}
    	\vspace*{-5mm}
      \item Provided infrastucture and support for \textit{all} ML applications powering the Call of Duty franchise on PC and console.
      \item Designed, built, maintained, and improved ML infrastructure specifically for the advanced analytics and ML team, but also for the organization at large.  
      \item Built near-realtime (10s of seconds) applications to combat cheating and malicious behavior.  
