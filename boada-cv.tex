...
\textit{Senior Data Scientist, Gameplay} \hfill \textbf{January, 2024 - Present}\newline
As part of the game science team, I work to make Call of Duty better through data. In this role, I:
    \begin{list2}
        \item Partner with senior design leadership and cross-functional teams, including engineering and product management, to define key metrics, identify opportunities for game and business improvements, and drive data-informed decision making across the game.
        \item Lead initiatives to understand how gameplay systems (maps, modes, weapons, in-game communication) influence top-line KPIs and suggest design improvements based on data insights.
        \item Design, implement, and monitor experiments, A/B tests, and other methodologies to drive improvements in gameplay features and player engagement.
        ...
        \item Lead the development and implementation of data models, production metrics, and visualizations to provide insights into player behavior, gameplay patterns, and overall game performance.
...
\textit{Postdoctoral Research Associate} \hfill \textbf{September, 2016 - 2021}\newline
    ...
    \vspace*{-5mm}
        ...
        \item Collaborated with senior scientists and graduate students to ensure the quality of data products and oversee scientific analysis.
