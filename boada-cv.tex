...
As part of the game science team, I am responsible for making Call of Duty better through data. Currently, I am:
    \begin{list2}
%     	\vspace*{-5mm}
      \item Working with senior design leadership to understand how players interact with Call of Duty gameplay systems. This includes maps, modes, movement, weapons, and in-game communication among others.
      \item Leading initiatives to understand how game design affect topline KPIs, and suggest changes when appropriate.
      \item Supporting infrastructure improvements to better track or diagnose gameplay related issues.
    \end{list2}
...
% As part of the Advanced Analytics and Machine Learning (ML) team, I support all ML initiatives for the Call of Duty and Warzone franchises. This includes being involved in early concept designs through the productionalization of mature models and stakeholder management. Below are selected highlights from this very diverse role:
    \begin{list2}
%     	\vspace*{-5mm}
      \item Designed, built, maintained, and improved ML infrastructure. This includes tool developement like autoML, CI/CD (Jenkins, github actions), model tracking and management (MLflow) and orchestration (Airflow).
      ...
      \item Designed, built, and maintained near-realtime applications (via Spark streaming) to combat in-game cheating and other malicious behavior. Typical time-to-action in the low 10s of seconds.
      ...
      \item Supervised junior team members to design and developed recommendation systems productionalized in both Modern Warfare 2 (2022) and Modern Warfare 3 (2023). 
    \end{list2}
\vspace*{-2mm}
