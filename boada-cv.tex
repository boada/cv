...
As part of the game science team, I work to make Call of Duty better through data. In this role, I:
    \begin{list2}
        ...
        \item Drive data quality and ensure instrumentation across the game to capture accurate and actionable data; collaborate closely with engineering teams to improve data pipelines and ensure seamless data flow.
        ...
        \item Manage and mentor junior data scientists, offering guidance in experimental design, statistical analysis, and effective data visualization.
    \end{list2}
    \vspace*{-2mm}
