...
\textit{Postdoctoral Research Associate} \hfill \textbf{September, 2016 - 2020}\newline
    \begin{list2}
      ...
      to perform quality control tasks; deliver science products; and produce peer-reviewed publications. See: \href{http://arxiv.org/abs/1809.06378}{ArXiv:1808.06378}
    	\item Contributed to widely used, open source, Python projects through bug fixes and feature additions: \href{https://github.com/boada/photometrypipeline}{\sc{photometrypipeline}}, \href{http://astlib.sourceforge.net/}{\sc{astLib}}, and \href{https://github.com/boada/easyGalaxy}{\sc{easyGalaxy}}.
    \end{list2}
\vspace*{-3mm}
...
\textbf{Predicting Tournament Performance in Warmachine}\newline
    \begin{list2}
    	...
    	\item Wrangled $\sim$1800 tournament game results of a popular tabletop game using Python (e.g., Pandas).
    \end{list2}
\vspace*{-2mm}
